<template>
    ...
    >
        ...
        <form ref="form" @submit.prevent="add_carousel">
            ...
            <b-button variant="outline-primary" v-on:click="add_carousel" :disabled="submitted" class="mr-1">
    ...
    export default {
        ...
        methods: {
            ...
            add_carousel(){
                ...
                this.addCarousel({data:form_data}).then((res) => {
